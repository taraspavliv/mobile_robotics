...
capture = cv.VideoCapture("new3.mp4") #"https://192.168.1.156:8080" 1 + cv.CAP_DSHOW
...
def kalman_thread():
    ...
    R = np.array([[0.01,0.,0.,0.,0.,0.],[0.,0.01,0.,0.,0.,0.],[0.,0.,0.01,0.,0.,0.],[0.,0.,0.,0.01,0.,0.],[0.,0.,0.,0.,0.00001,0.],[0.,0.,0.,0.,0.,0.1]])
